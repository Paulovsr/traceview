...
/***/ "./src/app/core/plataform-detector/platform-detector.service.ts":
/*!**********************************************************************!*\
  !*** ./src/app/core/plataform-detector/platform-detector.service.ts ***!
  \**********************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _signin_signin_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./signin/signin.component */ "./src/app/home/signin/signin.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _shared_components_vmessage_vmessage_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/components/vmessage/vmessage.module */ "./src/app/shared/components/vmessage/vmessage.module.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _singup_singup_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./singup/singup.component */ "./src/app/home/singup/singup.component.ts");
...
/* harmony import */ var _singup_signup_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./singup/signup.service */ "./src/app/home/singup/signup.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    HomeModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _singup_singup_component__WEBPACK_IMPORTED_MODULE_6__["SignUpComponent"],
            ...
            imports: [
                ...
                _shared_components_vmessage_vmessage_module__WEBPACK_IMPORTED_MODULE_4__["VMessageModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"],
                _home_routing_module__WEBPACK_IMPORTED_MODULE_8__["HomeRoutingModule"]
            ],
            providers: [
                _singup_signup_service__WEBPACK_IMPORTED_MODULE_9__["SignUpService"]
            ]
        })
    ], HomeModule);
    return HomeModule;
...
/* harmony import */ var _singup_singup_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./singup/singup.component */ "./src/app/home/singup/singup.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'signup',
                component: _singup_singup_component__WEBPACK_IMPORTED_MODULE_4__["SignUpComponent"],
                data: {
                    title: 'Sign up'
                }
            },
...
/* harmony import */ var _core_plataform_detector_platform_detector_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../core/plataform-detector/platform-detector.service */ "./src/app/core/plataform-detector/platform-detector.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SignInComponent = /** @class */ (function () {
    function SignInComponent(formBuilder, authService, router, platformDetectorService, activatedRoute) {
    ...
    SignInComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute
            .queryParams
            .subscribe(function (params) { return _this.fromUrl = params['fromUrl']; });
    ...
    SignInComponent.prototype.login = function () {
        ...
        this.authService
            ...
            .subscribe(function () { return _this.fromUrl
            ? _this.router.navigateByUrl(_this.fromUrl)
            : _this.router.navigate(['user', userName]); }, function (err) {
            console.log(err);
            _this.loginForm.reset();
            _this.platformDetectorService.isPlatformBrowser() &&
    ...
    SignInComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            ...
            _core_plataform_detector_platform_detector_service__WEBPACK_IMPORTED_MODULE_4__["PlatformDetectorService"],
...
/***/ "./src/app/home/singup/signup.component.html":
/*!***************************************************!*\
  !*** ./src/app/home/singup/signup.component.html ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/home/singup/signup.service.ts":
/*!***********************************************!*\
  !*** ./src/app/home/singup/signup.service.ts ***!
  \***********************************************/
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _shared_validators_lower_case_validator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/validators/lower-case.validator */ "./src/app/shared/validators/lower-case.validator.ts");
/* harmony import */ var _user_not_taken_validator_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./user-not-taken.validator.service */ "./src/app/home/singup/user-not-taken.validator.service.ts");
/* harmony import */ var _signup_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./signup.service */ "./src/app/home/singup/signup.service.ts");
/* harmony import */ var _core_plataform_detector_platform_detector_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../core/plataform-detector/platform-detector.service */ "./src/app/core/plataform-detector/platform-detector.service.ts");
/* harmony import */ var _username_password_validator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./username-password.validator */ "./src/app/home/singup/username-password.validator.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(formBuilder, userNotTakenValidatorService, signUpService, router, platformDetectorService) {
        this.formBuilder = formBuilder;
    ...
    SignUpComponent.prototype.ngOnInit = function () {
        this.signupForm = this.formBuilder.group({
            ...
            userName: ['',
                [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
                    _shared_validators_lower_case_validator__WEBPACK_IMPORTED_MODULE_3__["lowerCaseValidator"],
                    _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(2),
            ...
            validator: _username_password_validator__WEBPACK_IMPORTED_MODULE_7__["userNamePassword"]
        });
        this.platformDetectorService.isPlatformBrowser() &&
    ...
    SignUpComponent.prototype.signup = function () {
        ...
        if (this.signupForm.valid && !this.signupForm.pending) {
            ...
            this.signUpService
                .signup(newUser)
                .subscribe(function () { return _this.router.navigate(['']); }, function (err) { return console.log(err); });
        }
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('emailInput'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], SignUpComponent.prototype, "emailInput", void 0);
    SignUpComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            template: __webpack_require__(/*! ./signup.component.html */ "./src/app/home/singup/signup.component.html"),
            providers: [_user_not_taken_validator_service__WEBPACK_IMPORTED_MODULE_4__["UserNotTakenValidatorService"]]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            _user_not_taken_validator_service__WEBPACK_IMPORTED_MODULE_4__["UserNotTakenValidatorService"],
            _signup_service__WEBPACK_IMPORTED_MODULE_5__["SignUpService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _core_plataform_detector_platform_detector_service__WEBPACK_IMPORTED_MODULE_6__["PlatformDetectorService"]])
    ], SignUpComponent);
...
/***/ "./src/app/home/singup/user-not-taken.validator.service.ts":
/*!*****************************************************************!*\
  !*** ./src/app/home/singup/user-not-taken.validator.service.ts ***!
  \*****************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _signup_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./signup.service */ "./src/app/home/singup/signup.service.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    ...
    UserNotTakenValidatorService.prototype.checkUserNameTaken = function () {
        ...
        return function (control) {
            return control
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (userName) {
                return _this.signUpService.checkUserNameTaken(userName);
            }))
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (isTaken) { return isTaken ? { userNameTaken: true } : null; }))
...
/***/ "./src/app/home/singup/username-password.validator.ts":
/*!************************************************************!*\
  !*** ./src/app/home/singup/username-password.validator.ts ***!
  \************************************************************/
...
var userNamePassword = function (formGroup) {
...
module.exports = "<small class=\"text-danger d-block mt-2\">{{ text }}</small> "
...
var VMessageComponent = /** @class */ (function () {
    ...
    ], VMessageComponent.prototype, "text", void 0);
...
/***/ "./src/app/shared/validators/lower-case.validator.ts":
/*!***********************************************************!*\
  !*** ./src/app/shared/validators/lower-case.validator.ts ***!
  \***********************************************************/
